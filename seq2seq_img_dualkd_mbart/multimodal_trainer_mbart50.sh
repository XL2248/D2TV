...
sign=output_model_with_img_dualkd_nosharedvanillaKD_use_lr_factor${IMG_LR_FACTOR}_mbart50_only_multitask_linear_optimization_newimg
...
export model_name="/path_to/mbart-large-50-many-to-many-mmt/"
# optimization settings
export learning_rate=${IMG_LR_FACTOR} #5e-5
...
export HDF5_USE_FILE_LOCKING=false
export HDF5_USE_FILE_LOCKING=FALSE
BASE_DIR=/code_path/seq2seq_img_dualkd_mbart
...
#                   --nproc_per_node=$NPROC_PER_NODE \
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch \
        ...
        --do_train \
        --use_langid \
        --langid_map_path "${BASE_DIR}/debug/extra_tokens_langid_map_mbart.json" \
